      ...
      <RevealOnScroll>
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex flex-col md:items-end justify-center gap-8">
            <a href="mailto:***REDACTED***" className="text-2xl md:text-3xl font-medium hover:text-neutral-600 dark:hover:text-neutral-400 transition-colors flex items-center gap-4 group font-inter break-all">
