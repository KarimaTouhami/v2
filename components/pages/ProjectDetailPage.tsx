  ...
  return (
    <div className="pt-28 min-h-screen max-w-6xl mx-auto px-6">
      ...
      <div className="grid lg:grid-cols-2 gap-8 md:gap-16 mb-20 items-start">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-neutral-200 dark:border-neutral-800 animate-in slide-in-from-bottom-8 duration-1000 delay-200 fade-in fill-mode-both aspect-square order-1 lg:order-2">
