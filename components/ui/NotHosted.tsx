...
interface NotHostedModalProps {
  isOpen: boolean;
  onClose: () => void;
}
 
export const NotHostedModal: React.FC<NotHostedModalProps> = ({ isOpen, onClose }) => {
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border-2 border-neutral-200 dark:border-neutral-800 max-w-lg w-full p-8 md:p-10 animate-in zoom-in-95 duration-300 relative">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-lg mb-6 leading-relaxed">
            This project is not hosted online and cannot be accessed publicly. 
          </p>
          ...
          <div className="bg-neutral-50 dark:bg-neutral-800 rounded-2xl p-6 mb-8 border border-neutral-200 dark:border-neutral-700">
            <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-3">
              <span className="font-bold text-neutral-900 dark:text-white">Why it&apos;s not hosted:</span>
            </p>
            <ul className="text-sm text-neutral-600 dark:text-neutral-400 text-left space-y-2">
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>This is a local/development project</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>It requires specific environment setup</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Not intended for public deployment</span>
              </li>
            </ul>
          </div>
