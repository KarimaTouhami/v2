...
export const CustomCursor: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => { setIsVisible(false); isRunning = false; };
    const handleMouseEnter = () => { setIsVisible(true); isRunning = true; requestRef = requestAnimationFrame(moveCursor); };
